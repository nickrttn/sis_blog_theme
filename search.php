			...
			<div class="articles">
				...
				<?php if(have_posts()) : ?> 
					...
					<div class="additional-content">
						...
						<h3><?php _e('Search Results for: ', 'sparrowinspace-framework'); ?><?php echo get_search_query(); ?></h3>
				...
				<?php endwhile; else : ?>
					...
					<article>
						<h1><?php _e('No results were found matching your criteria.', 'sparrowinspace-framework'); ?></h1>
					</article>
